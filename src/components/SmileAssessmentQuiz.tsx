  ...
  const getRecommendation = () => {
    if (answers.goal === 'rct' || answers.symptom === 'throbbing') {
      return {
        ...
        doctorTip: "Avoid hot fluids and do not place aspirin on the gum. Dr. Kiruthika Asokan will perform a digital radiograph upon arrival.",
      ...
      return {
        ...
        desc: "Replacing missing teeth restores chewing strength and prevents facial bone recession. Dr. Kiruthika Asokan provides computer-guided implant planning with life-long durability.",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-600 text-sm sm:text-base mt-2">
            Answer 3 quick questions to receive an instant personalized recommendation from Dr. Kiruthika Asokan.
          </p>
        </div>
            ...
            <div>
              ...
              {currentStep === 2 && (
                <div className="animate-fadeIn">
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 mb-6">
                    This helps Dr. Kiruthika Asokan prepare relevant diagnostic tools for your visit.
                  </p>
              ...
              {currentStep === 3 && (
                <div className="animate-fadeIn">
                  <h3 className="font-serif text-xl sm:text-2xl font-bold text-slate-900 mb-2">
                    When would you prefer to visit Porur, Chennai?
                  </h3>
                  <p className="text-xs sm:text-sm text-slate-500 mb-6">
