  ...
  const steps = [
    {
      ...
      desc: 'You are greeted into our tranquil clinic behind Grand Residence in Karambakkam, Porur. We start with comfortable digital imaging and a relaxed conversation with zero rush.',
    ...
    },
    {
      ...
      desc: 'Dr. Kiruthika Asokan walks you through your digital scans, explaining every option with complete transparency so you are 100% in control of your dental decisions.',
      icon: <ShieldCheck className="w-6 h-6 text-gold-600" />
    },
    {
      number: '03',
      title: 'Gentle & Painless Care',
      subtitle: 'Advanced rotary tools & gentle numbing',
      desc: 'Lie back in our ergonomic dental suite. Utilizing specialized tools and gentle hands, discomfort is eliminated.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs uppercase font-bold tracking-widest text-gold-700 mb-2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gold-50 border border-gold-200">
            ...
            <span>The Dr Kiruthika Asokan's Dental Experience</span>
          </span>
