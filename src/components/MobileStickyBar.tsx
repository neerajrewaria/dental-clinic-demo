  ...
  return (
    <aside aria-label="Quick Mobile Actions" className="fixed bottom-0 inset-x-0 z-40 lg:hidden p-3 bg-white/95 backdrop-blur-xl border-t border-sand-200/90 shadow-[0_-10px_25px_rgba(0,0,0,0.08)]">
      <div className="max-w-md mx-auto grid grid-cols-4 gap-2">
        ...
        {/* WhatsApp Direct */}
        <a
          href={`https://wa.me/${CLINIC_DATA.whatsapp}?text=Hello%20Dr.%20Manju,%20I%20would%20like%20to%20inquire%20about%20a%20consultation%20at%20Vrinda%20Dental%20Clinic.`}
          target="_blank"
